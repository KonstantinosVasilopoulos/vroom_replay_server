...
import net.sytes.dwms.gps_not_updating.functions.GpsNotUpdatingDetector;
import net.sytes.dwms.gps_not_updating.functions.TotalValidator;
import net.sytes.dwms.gps_not_updating.influxdb.sink2.InfluxDBSink;
...
public class DataStreamJob {
	...
	public static void main(String[] args) throws Exception {
		...
		// Identify GPS not updating events
		final DataStream<GpsNotUpdatingEvent> gpsNotUpdatingEvents = validatedData
				.keyBy(CanonicTotal::getCarId)
				.process(new GpsNotUpdatingDetector())
				.uid("gps-not-updating-detector");

		// Insert events into InfluxDB
		InfluxDBSink<GpsNotUpdatingEvent> influxDBSink = InfluxDBSink.builder()
				.setInfluxDBSchemaSerializer(new GpsNotUpdatingEventSerializer())
				...
				.build();
		gpsNotUpdatingEvents.sinkTo(influxDBSink);

		// Execute program, beginning computation
		env.execute("GPS Not Updating Job");
	}
}
