 ...
 */
package net.sytes.dwms.low_fps.influxdb.sink2;

import net.sytes.dwms.low_fps.influxdb.sink2.writer.InfluxDBSchemaSerializer;
import net.sytes.dwms.low_fps.influxdb.sink2.writer.InfluxDBWriter;
import org.apache.flink.configuration.Configuration;

import static net.sytes.dwms.low_fps.influxdb.sink2.InfluxDBSinkOptions.*;
import static org.apache.flink.util.Preconditions.checkArgument;
import static org.apache.flink.util.Preconditions.checkNotNull;

/**
 * The @builder class for {@link net.sytes.dwms.low_fps.influxdb.sink2.InfluxDBSink} to make it easier for the users to construct a {@link
 * net.sytes.dwms.low_fps.influxdb.sink2.InfluxDBSink}.
 *
